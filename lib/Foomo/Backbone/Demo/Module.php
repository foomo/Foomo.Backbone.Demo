...
class Module extends \Foomo\Modules\ModuleBase
{
	 ...
	 *
	 */
	const NAME = 'Foomo.Backbone.Demo';
	...
	{
		return 'a demo for learning purposes';
	}
	...
	public static function getResources()
	{
		return array(
			...
			\Foomo\Modules\Resource\Module::getResource('Foomo.Less', '1.1.*'),
			\Foomo\Modules\Resource\Module::getResource('Foomo.Jasmine', '0.1.*')
